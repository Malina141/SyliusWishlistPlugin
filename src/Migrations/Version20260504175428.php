...
final class Version20260504175428 extends AbstractPostgreSQLMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE malina141_wishlist (id INT NOT NULL, owner_id INT DEFAULT NULL, channel_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE malina141_wishlist_item (id INT NOT NULL, wishlist_id INT NOT NULL, product_variant_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX malina141_wishlist_item_unique_variant_idx ON malina141_wishlist_item (wishlist_id, product_variant_id)');
        $this->addSql('ALTER TABLE malina141_wishlist ADD CONSTRAINT FK_7D1251067E3C61F9 FOREIGN KEY (owner_id) REFERENCES sylius_shop_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE malina141_wishlist ADD CONSTRAINT FK_7D12510672F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE malina141_wishlist_item ADD CONSTRAINT FK_3BFCB8C7FB8E54CD FOREIGN KEY (wishlist_id) REFERENCES malina141_wishlist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE malina141_wishlist_item ADD CONSTRAINT FK_3BFCB8C7A80EF684 FOREIGN KEY (product_variant_id) REFERENCES sylius_product_variant (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
